...
with DAG(
    ...
    # Copy champion ti s3 bucket
    copy_job = DataprocCreatePysparkJobOperator(
        cluster_id=cluster_id_tmpl,
        task_id="copy",
        main_python_file_uri=f"{S3_SRC_BUCKET}/copy_model.py",
        ...
        args=[
            ...
            "--s3-model", f"{S3_CLEAN_PATH.rstrip('/')}/model",
    ...
    setup_connections >> create_spark_cluster >> copy_job >> delete_spark_cluster
